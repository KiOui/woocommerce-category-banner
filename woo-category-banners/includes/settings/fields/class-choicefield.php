...
include_once WCB_ABSPATH . 'includes/settings/fields/class-settingsfield.php';
			...
			<select name="<?php echo esc_attr( $this->id ); ?>">
				...
				<?php if ( ! $setting_selected && isset( $current_value ) && '' !== $current_value ) : ?>
					<option selected value="<?php echo esc_attr( $current_value ); ?>">
						<?php echo esc_html( sprintf( __( 'Currently set value %s', 'woo-category-banners' ), $current_value ) ); ?>
					</option>
				<?php endif; ?>
			</select>
			<?php
